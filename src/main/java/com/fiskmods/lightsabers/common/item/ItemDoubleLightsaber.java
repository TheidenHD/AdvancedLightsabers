...
//        Vec3d vec3 = VectorHelper.getOffsetCoords(attacker, 0, 0, -0.2F);
...
//        List<EntityLivingBase> list = attacker.getEntityWorld().selectEntitiesWithinAABB(EntityLivingBase.class, aabb, IEntitySelector.selectAnything);
//
...
//
//                                    player.addStat(StatList.DAMAGE_DEALT, Math.round(attackDamage * 10.0F));
//
//                                    if (fire > 0)
//                                    {
