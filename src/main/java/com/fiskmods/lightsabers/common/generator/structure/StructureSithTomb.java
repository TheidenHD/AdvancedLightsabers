...
//{
//    public StructureSithTomb(World world, BlockPos pos)
//    {
//        super(world, pos);
//    }
//
...
//        int k;
//
//        for (k = 63; !world.isAirBlock(xCoord, k + 1, zCoord + 17 + stairLength); ++k)
//        {
//            ;
//        }
//
...
//                int k = 0;
//
//                while (k > 0 && world.isAirBlock(xCoord + 4 - j, yCoord - 1 + k, zCoord + 1 + i))
//                {
//                    --k;
//                    BiomeGenBase biome = world.getBiomeGenForCoords(xCoord + 4 - j, zCoord + 1 + i);
...
//
//        TileEntitySithStoneCoffin tile = (TileEntitySithStoneCoffin) world.getTileEntity(xCoord + x, yCoord + y, zCoord + z);
//        TileEntitySithCoffin tile1 = (TileEntitySithCoffin) world.getTileEntity(xCoord + coffinX, yCoord + coffinY, zCoord + coffinZ);
//
