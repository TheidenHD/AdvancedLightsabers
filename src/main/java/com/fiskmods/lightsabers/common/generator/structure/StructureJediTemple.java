//package com.fiskmods.lightsabers.common.generator.structure; //TODO
//
...
//        if (ruination > 0)
//        {
//            if (block == Blocks.LEAVES || block == Blocks.WATER || block == Blocks.LEAVES2)
//            {
//                return;
//            }
//            else if (block.getMaterial(block.getDefaultState()) == Material.GLASS && rand.nextFloat() * rand.nextFloat() <= ruination)
//            {
//                return;
//            }
//            
...
//
//                    while (y > 0 && !world.getBlock(p.posX, y - 1, p.posZ).isSideSolid(world, p.posX, y - 1, p.posZ, ForgeDirection.UP))
//                    {
//                        world.setBlock(p.posX, --y, p.posZ, fillerBlock);
//                    }
//
//                    for (y = p.posY; y < clearance; ++y)
//                    {
//                        if (!world.isAirBlock(p.posX, y, p.posZ))
//                        {
//                            world.setBlock(p.posX, y, p.posZ, Blocks.air);
//                        }
//                    }
//                }
//
...
//            {
//                Vec3d vec3 = new Vec3d(0, j, 0);
//                vec3.rotateAroundX(rotX * (float) Math.PI / 180.0F);
//                vec3.rotateAroundY(rotY * (float) Math.PI / 180.0F);
//
//                setBlock(Blocks.LOG, 0, MathHelper.floor(vec3.xCoord), 1 + height + MathHelper.floor(vec3.yCoord), MathHelper.floor(vec3.zCoord));
//
...
//                        {
//                            Block block = world.getBlock(xCoord + MathHelper.floor(vec3.xCoord) + x, yCoord + 1 + height + MathHelper.floor(vec3.yCoord) + y, zCoord + MathHelper.floor(vec3.zCoord) + z);
//
//                            if (block != Blocks.LOG)
//                            {
//                                Vec3d src = new Vec3d(MathHelper.floor(vec3.xCoord) + 0.5F, 1 + height + MathHelper.floor(vec3.yCoord) + 0.5F, MathHelper.floor(vec3.zCoord) + 0.5F);
//                                Vec3d dst = src.addVector(x, y, z);
//
//                                if (src.distanceTo(dst) <= leafCoverage)
//                                {
//                                    setBlock(Blocks.leaves, 0, MathHelper.floor(vec3.xCoord) + x, 1 + height + MathHelper.floor(vec3.yCoord) + y, MathHelper.floor(vec3.zCoord) + z);
//                                }
//                            }
//                        }
//                    }
