...
public class ModRecipes
{
    ...
    {
//        GameRegistry.addShapedRecipe(new RecipesDoubleLightsaber()); //TODO
//        
//        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.lightForcestone, 4, 0), "###", "#-#", "###", '#', new ItemStack(Blocks.sandstone, 1, 2), '-', ModBlocks.lightsaberCrystal);
//        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.lightForcestone, 1, 1), "#", "#", '#', new ItemStack(ModBlocks.forcestoneSlab, 1, 0));
//        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.lightForcestone, 2, 2), "#", "#", '#', new ItemStack(ModBlocks.lightForcestone, 1, 0));
//        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.darkForcestone, 4, 0), "###", "#-#", "###", '#', Blocks.hardened_clay, '-', ModBlocks.lightsaberCrystal);
//        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.darkForcestone, 1, 1), "#", "#", '#', new ItemStack(ModBlocks.forcestoneSlab, 1, 1));
//        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.darkForcestone, 2, 2), "#", "#", '#', new ItemStack(ModBlocks.darkForcestone, 1, 0));
//        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.forcestoneSlab, 6, 0), "###", '#', new ItemStack(ModBlocks.lightForcestone, 1, 0));
//        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.forcestoneSlab, 6, 1), "###", '#', new ItemStack(ModBlocks.darkForcestone, 1, 0));
//        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.lightForcestoneStairs, 4), "#  ", "## ", "###", '#', new ItemStack(ModBlocks.lightForcestone, 1, 0));
//        GameRegistry.addShapedRecipe(new ItemStack(ModBlocks.darkForcestoneStairs, 4), "#  ", "## ", "###", '#', new ItemStack(ModBlocks.darkForcestone, 1, 0));
