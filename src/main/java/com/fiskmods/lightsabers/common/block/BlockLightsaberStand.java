...
//                else
//                {
//                    player.addChatMessage(new ChatComponentTranslation("message.lightsaberStand.notOwner").setChatStyle(new ChatStyle().setColor(TextFormatting.RED)));
//                }
//            }
//        }
//
...
//        if (metadata == 0)
//        {
//            int i = MathHelper.floor(entity.rotationYaw * 4F / 360F + 0.5) & 1;
