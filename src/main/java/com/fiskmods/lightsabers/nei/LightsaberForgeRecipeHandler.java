//package com.fiskmods.lightsabers.nei; //TODO
//
...
//        GuiDraw.drawString(StatCollector.translateToLocalFormatted("%s cm", ItemStack.DECIMALFORMAT.format(recipe1.data.getHeightCm())), 40, 54 - GuiDraw.fontRenderer.FONT_HEIGHT, -1);
//    }
//
//    @Override
