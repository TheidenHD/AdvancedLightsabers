//package com.fiskmods.lightsabers.nei; //TODO jie
//
...
//                {
//                    list.get(list.indexOf(entry)).getKey().getCount() += e.getKey().getCount();
//                }
//                else
//                {
//                    list.add(entry);
...
//            {
//                currenttip.add(String.format("%s%%", ItemStack.DECIMALFORMAT.format(e.getValue() * 100)));
//                break;
//            }
//        }
//
