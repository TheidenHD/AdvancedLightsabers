...
public class RenderHolocron extends TileEntitySpecialRenderer
{
    public void render(TileEntityHolocron tile, double x, double y, double z, float partialTicks)
    {
        ...
        if (tile.getWorld() != null || tile.getBlockMetadata() != -1)
        {
...
//        tessellator.setNormal(0, 10, 10); //TODO
    ...
    {
//        IIcon iconSide = ModBlocks.holocron.getIcon(0, metadata); //TODO
...
//        float minU = iconSide.getInterpolatedU(0); //TODO
...
//            tessellator.addVertexWithUV(0, size / 2, size / 2, minU, maxV);
        ...
        for (int i = 0; i < 2; ++i)
        {
            for (int j = 0; j < 4; ++j)
            {
//                tessellator.startDrawing(GL11.GL_TRIANGLES); //TODO
...
//                    tessellator.addVertexWithUV(0, 0, height, minU, minV);
    ...
    {
//        IIcon iconBottom = ModBlocks.holocron.getIcon(0, metadata); //TODO
