...
public class GuiOverlay extends Gui
{
    ...
    public void onRenderGameOverlayPre(RenderGameOverlayEvent.Pre event)
    {
        ...
        if (event.getType() == ElementType.EXPERIENCE || event.getType() == ElementType.JUMPBAR)
        {
...
//                for (StatusEffect status : ALEntityData.getData(player).activeEffects) //TODO
//                {
...
//                    {
//                        ((PowerEffectActive) powerEffect).render(player, event.getPartialTicks());
//                    }
//                }
    ...
    public void renderForceBar(RenderGameOverlayEvent.Post event, int width, int height, EntityPlayer player)
    {
        ...
        if (cap > 0)
        {
            ...
            String s = MathHelper.floor(ALData.FORCE_POWER.get(player)) + "/" + cap;
...
//            } TODO
    ...
    {
        GL11.glEnable(GL11.GL_BLEND);
        //ALEntityData data = ALEntityData.getData(player); //TODO
        int left = width - 3;
        int top = height - 28;
...
//        for (int i = 0; i < data.activeEffects.size(); ++i) //TODO
//        {
...
//                {
//                    s += " " + I18n.translateToLocal("enchantment.level." + (status.amplifier + 1));
//                }
//
